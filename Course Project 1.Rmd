...
download.file(fileURL, "my_data.zip", method = "curl")
unzip("my_data.zip")
...
The steps mean is 10766.19, while the steps median is 10765.
...
weekly_data$date <- as.Date(weekly_data$date,"%m/%d/%y")
